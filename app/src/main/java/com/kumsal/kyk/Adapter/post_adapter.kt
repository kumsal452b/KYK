...
class post_adapter(private var list: ArrayList<post_model>, private var context: Context) :
    ...
    inner class postHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        var name: TextView = itemView.findViewById(R.id.activity_post_detail_name)
        var username: TextView = itemView.findViewById(R.id.activity_post_detail_username)
        var since: TextView = itemView.findViewById(R.id.activity_post_detail_sinceTime)
        var expanded: ImageButton = itemView.findViewById(R.id.activity_post_detail_expanded)
